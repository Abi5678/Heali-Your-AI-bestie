  ...
  const handleTestCall = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          title: "Calling...",
          description: "Heali is initiating a test call to your phone.",
        });
      } else {
            ...
            <CardContent className="pt-6 space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <Label className="text-base">Enable Phone Calls</Label>
                  <p className="text-sm text-muted-foreground">Receive AI voice reminders for critical slots.</p>
                </div>
                <Switch 
              ...
              {prefs.voice_reminders_enabled && (
                <div className="space-y-3 pt-4 border-t animate-in fade-in slide-in-from-top-2 duration-300">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">We'll only use this for your health reminders.</p>
                </div>
              )}
              ...
              {prefs.voice_reminders_enabled && (
                <div className="pt-4 flex flex-col gap-2">
                  ...
                  >
                    ...
                    {testing ? 'Initiating...' : 'Send Test Call'}
                  </Button>
                  <p className="text-[10px] text-center text-muted-foreground">
                    This will trigger an immediate call to verify your connection.
                  </p>
                </div>
              )}
            </CardContent>
